...
public class SuperCoins extends Fragment implements OnProductItemClickListener {
    ...
    public static SuperCoins newInstance() {
        SuperCoins fragment = new SuperCoins();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_super_coins, container, false);
    }
    ...
    private void initViews(View view) {
        ...
        rvDailyDeals = view.findViewById(R.id.rvSuperCoin);
